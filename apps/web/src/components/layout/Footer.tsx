  ...
  return (
    <footer className="bg-secondary border-t border-gray-200/50 pt-16 pb-8">
      <div className="container-width grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        {/* Shop Links */}
        <div>
          <h4 className="text-xs uppercase tracking-[0.2em] text-muted font-medium mb-6">Shop</h4>
        ...
        {/* Customer Service */}
        <div>
          <h4 className="text-xs uppercase tracking-[0.2em] text-muted font-medium mb-6">Customer Service</h4>
          <ul className="space-y-3">
            <li>
        ...
        {/* Newsletter */}
        <div>
          <h4 className="text-xs uppercase tracking-[0.2em] text-muted font-medium mb-6">Newsletter</h4>
          <p className="text-sm text-muted mb-4">Subscribe for exclusive offers and new arrivals.</p>
      ...
      <div className="container-width border-t border-gray-200/50 pt-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-xs uppercase tracking-[0.1em] text-muted mr-2">Pay with</span>
            {/* Visa */}
            <svg className="h-6 w-auto text-muted" viewBox="0 0 50 16" fill="currentColor">
            ...
            {/* Mastercard */}
            <svg className="h-6 w-auto text-muted" viewBox="0 0 50 32" fill="currentColor">
              <circle cx="18" cy="16" r="10" opacity="0.5" />
              <circle cx="32" cy="16" r="10" opacity="0.7" />
            </svg>
            {/* Bank Transfer */}
            <svg className="h-5 w-auto text-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
        ...
        <div className="text-center mt-8 pt-6 border-t border-gray-200/50">
          <p className="text-xs text-muted tracking-[0.1em]">© {new Date().getFullYear()} JFS WEARS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
